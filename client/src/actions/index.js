...
var WanRecipes = [
    ...
    },
    {
        ...
        "spoonacularSourceUrl": "https://spoonacular.com/carrot-and-cabbage-salad-with-coriander+cumin-dry-rub-637162"
    },
    {
        "vegetarian": false,
        "vegan": false,
...
async function getWanRecipes() {
    try {
        console.log('WANRECIPES',WanRecipes)
...
export function setRecipeDetail(id) {
    console.log('SETRECIPEDETAIL ACTIONS',id)
    return function (dispatch) {
        dispatch({ type: 'RECIPE_DETAIL', payload: parseInt(id) })
    }
}
